...
namespace Metadata.API.Migrations
{
    ...
    [Migration("20231111144028_Add_Fields_Asset_Unit_Id_to_Asset_Compensations")]
    partial class AddFieldsAssetUnitIdtoAssetCompensations
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Metadata.Core.Entities.AttachFile", b =>
                {
                    ...
                    b.Property<bool>("IsAssetCompensation")
                        .HasColumnType("bit")
            ...
            modelBuilder.Entity("Metadata.Core.Entities.Plan", b =>
                {
                    ...
                    b.Property<string>("PlanReportInfo")
                        .IsRequired()
                        .HasMaxLength(200)
                        .HasColumnType("nvarchar(200)")
            ...
            modelBuilder.Entity("Metadata.Core.Entities.Support", b =>
                {
                    ...
                    b.Property<decimal>("SupportUnitPrice")
                        .HasColumnType("decimal(18, 0)")
