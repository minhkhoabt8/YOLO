...
namespace Metadata.Infrastructure.Repositories.Interfaces
{
        ...
        IQueryAsync<MeasuredLandInfo, MeasuredLandInfoQuery>
    {
        ...
        Task<bool> HasDuplicateMeasuredPlotAsync(string ownerId, string measuredPlotNumber, string measuredPlotAddress, string landTypeId);
        Task<bool> HasDuplicateMeasuredPlotAndAddressAsync(string ownerId, string measuredPlotNumber, string measuredPlotAddress);
    }
}
